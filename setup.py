...
print("Before continuing with the setup!","Please make sure you downloaded Putty scp [pscp.exe]","Either google for Putty/Pscp or visit","  http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html\n", sep="\n")
